...
-- Добавить 5 строк.
INSERT INTO employees(firstName, lastName, job, age, userName) VALUES 
        ('Anna'
        , 'Dereck'
        , 'Senior Teacher'
        , 72
...
-- в этой базе создать таблицу Staff
CREATE TABLE Staff (
...
from staff
where age > 20 and username like 'A%';
